// Allows to transfer UV-texture (custom texture) to the destination.
// Works for 2D arrays.
// Works with the UV Mask, so if you brushed-away at some location, the texture won't be transfered there :)
Shader "Unlit/Blit_uvTexMasked"
{
    SubShader
    {
