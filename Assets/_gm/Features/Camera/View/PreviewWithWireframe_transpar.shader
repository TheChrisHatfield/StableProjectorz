...
//
// TRANSPARENT VERSION OF THE 'PreviewWithWireframe' shader
//
Shader "Custom/PreviewWithWireframe_transpar (Unlit Texture)"
{
    Properties 
    {
        [Header(Wireframe)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 _WireColor;
            float _Fade_WireOpacity01; //globally set for all meshes. Fades in the wireframe effect, during object-select-mode.
            ...
            fixed4 frag (g2f i) : SV_Target{
                ...
                // Smooth our line out 
                float a  =  exp2(-0.3 * minDistanceToEdge * minDistanceToEdge); 
                      a *= _WireColor.a * _Fade_WireOpacity01;

                return float4 (_WireColor.rgb, a);
            }
            ENDCG
        }
    }
